...
const MessageContainer = ({
  ...
  const renderCustomComponent = () => /*#__PURE__*/React.createElement(CustomComponent, {
    answers: answers,
  ...
  return /*#__PURE__*/React.createElement(Container$9, {
    isUser: isUser
  }, !showing ? /*#__PURE__*/React.createElement(Container$6, {
    marginLeft: !src ? 50 : 0
  }, loadingComponent) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Container$3, null, src ? /*#__PURE__*/React.createElement(Container$7, {
    alt: "Bot Avatar",
    src: src
  ...
  }), bubble ? (content || CustomComponent) && /*#__PURE__*/React.createElement(Container$8, {
    isUser: isUser
  }, content, CustomComponent && renderCustomComponent()) : CustomComponent && /*#__PURE__*/React.createElement(Container$2, null, renderCustomComponent())), options && !disableOptions && /*#__PURE__*/React.createElement(Container$5, null, options.map(option => /*#__PURE__*/React.createElement(Container$4, {
    key: option.value,
    onClick: () => callHandleAnswer(option)
  }, option.content)))));
};

var Message = /*#__PURE__*/memo(MessageContainer);
...
const Bot$1 = ({
  ...
  const renderMessage = (key, message, index) => /*#__PURE__*/React.createElement(Message, {
    key: key,
  ...
  return /*#__PURE__*/React.createElement(Container$m, null, /*#__PURE__*/React.createElement(Container$l, null, /*#__PURE__*/React.createElement(Container$h, null, /*#__PURE__*/React.createElement(Container$i, null, header)), /*#__PURE__*/React.createElement(Container$d, null, /*#__PURE__*/React.createElement(Container$c, {
    onClick: handleResetChat
  }, refreshComponent), /*#__PURE__*/React.createElement(Container$f, {
    onClick: toggleOpen
  }, closeComponent))), /*#__PURE__*/React.createElement(Container$k, {
    id: "rbc-chat-body"
  }, messages && messages.length > 0 && messages.map((message, index) => renderMessage(`KEY-${message.id}-${index}`, message, index))), (!isDisabled || error || end) && /*#__PURE__*/React.createElement(Container$j, {
    error: error
  }, end ? /*#__PURE__*/React.createElement(Container$a, null, endContent) : !error ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Container$g, {
    autoFocus: true,
    value: value,
  ...
  }, sendComponentFunction(disableSend())))) : /*#__PURE__*/React.createElement(Container$b, null, error)));
};
...
const IconContainer = ({
  ...
  return chatButtonComponent ? /*#__PURE__*/React.createElement("div", {
    style: propsStyle
  }, chatButtonComponent) : /*#__PURE__*/React.createElement(Container$1, {
    theme: theme,
    chatStyle: chatStyle
  }, /*#__PURE__*/React.createElement(Container, null, chatButtonComponent));
};
...
const Bot = ({
  ...
  return hidden ? /*#__PURE__*/React.createElement(React.Fragment, null) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: open ? "react-best-chatbot-visible" : "react-best-chatbot-hidden"
  }, init && /*#__PURE__*/React.createElement(Bot$1, {
    key: key,
    theme: theme,
    options: options,
    steps: steps,
...
const ChatBot = ({
  ...
  return /*#__PURE__*/React.createElement(ThemeProvider, {
    theme: theme
  }, /*#__PURE__*/React.createElement(Bot, _extends({
    theme: theme
  }, componentProps)));
};
